...
c     ! no-mass weighted L, which is the Mass Weighted 2nd Derivative
...
c     re=0.9579205d0; theta=75.5003530d0
       data (VL1(I),I=1,nd)/0.049719d0,0.0d0,0.0d0,-0.394576d0,
     & 0.0d0,0.585725d0,-0.394576d0,0.0d0,-0.585725d0/
       data (VL2(I),I=1,nd)/-0.070817d0,0.0d0,0.0d0,0.561950d0,
     & 0.0d0,0.426268d0,0.561950d0,0.0d0,-0.426268d0/
       data (VL3(I),I=1,nd)/0.0d0,0.0d0,-0.070304d0,-0.431590d0,
     & 0.0d0,0.557906d0,0.431590d0,0.0d0,0.557906d0/
     ...
     & 0.983256137d0,0.00000,1.431214542d0/
       ...
       do 400 Q1=-1.0, 1.0, 0.1
       do 300 Q2=-1.0, 1.0, 0.1
       do 200 Q3=-1.0, 1.0, 0.1
          do 100 I=1,nd
 ...
 100  continue
          ...
          th=theta*180.0d0/dacos(-1.0d0)
          vcm=vtot*htocm
          write(6,999) Q1,Q2,Q3,rOH1,rOH2,th,vcm
 200  continue  
 300  continue  
 400  continue  
 999  format(1x,3f8.2,3f15.6,f20.8)
      end 
