...
c    nth,nr1,nr2 must be the actural used values
      ...
      dimension trad3(nr3max,nr3max),xrad3(nr3max)
      dimension wvib3(nr3max,nr3max),evib3(nr3max)
      dimension phi0a(0:jmax,nr1max,nr2max,nr3max) 
      common /bdata/ama,amb,amc,rbohr,const,pi
      common /phi/phi0(0:jmax,nr1max,nr2max,nr3max),
     &phi1(0:jmax,nr1max,nr2max,nr3max),
     & vp(0:jmax,nr1max,nr2max,nr3max)
...
c     kl : the total number of Lanczos steps
      ...
      r2e=0.0d0
      r3e=0.0d0
      write(*,*)'r1e,r2e,r3e= ',r1e,r2e,r3e
      call podvr1(npd,rmin1,rmax1,r2e,r3e,wvib1,evib1,
     &                  trad1,xrad1,amu1)
      call podvr2(npd,rmin2,rmax2,r1e,r3e,wvib2,evib2,
     &trad2,xrad2,amu2)
      call podvr3(npd,rmin3,rmax3,r1e,r2e,wvib3,evib3,
     &trad3,xrad3,amu3)
...
c     calculate H*Phi
       call hphi(xrad1,xrad2,xrad3,trad1,trad2,trad3,iparity,jtot,
     & amu1,amu2,amu3)
...
c     print*,' The program ended at   ',system2
 ...
 1	x1(i)=x3(i)*x2(i)
       ...
       subroutine hphi(xrad1,xrad2,xrad3,trad1,trad2,trad3,iparity,jtot,
     & amu1,amu2,amu3)
      include 'parmar.f'
      implicit real*8(a-h,o-z)
c      calculate H*Phi
...
C     Phi1=H*Phi0, vp is the potential matrix
      ...
      dimension xrad3(nr3max),trad3(nr3max,nr3max)
      dimension ww(nr3max) 
      common /bdata/ama,amb,amc,rbohr,const,pi
      common /phi/phi0(0:jmax,nr1max,nr2max,nr3max),
     &phi1(0:jmax,nr1max,nr2max,nr3max),
...
c      if(mod(jmod,2).eq.0) then 
      ...
      do 10 ir2=1,nr2
      do 10 ir3=1,nr3
  10  phi1(mz,ir1,ir2,ir3)=vp(mz,ir1,ir2,ir3)*phi0(mz,ir1,ir2,ir3)
      do 20 mz=0,jtot
      do 20 ir2=1,nr2
      do 20 ir3=1,nr3
      do 21 ir1=1,nr1
  21  ww(ir1)=phi0(mz,ir1,ir2,ir3)

      do 20 ir1=1,nr1
      sum=0
      do 22 jr1=1,nr1
 22   sum=sum+trad1(ir1,jr1)*ww(jr1)
 20   phi1(mz,ir1,ir2,ir3)=phi1(mz,ir1,ir2,ir3)+sum
      do 30 mz=0,jtot
      do 30 ir1=1,nr1
      do 30 ir3=1,nr3
      do 31 ir2=1,nr2
  31  ww(ir2)=phi0(mz,ir1,ir2,ir3)
      do 30 ir2=1,nr2
      sum=0
      do 32 jr2=1,nr2
  32  sum=sum+trad2(ir2,jr2)*ww(jr2)
  30  phi1(mz,ir1,ir2,ir3)=phi1(mz,ir1,ir2,ir3)+sum
      do 40 mz=0,jtot
      do 40 ir1=1,nr1
      r1=xrad1(ir1)
      do 40 ir2=1,nr2
      r2=xrad2(ir2)
      do 41 ir3=1,nr3
 41   ww(ir3)=phi0(mz,ir1,ir2,ir3)
      do 40 ir3=1,nr3
      sum=0
      do 42 jr3=1,nr3
 42   sum=sum+ trad3(ir3,jr3)*ww(jr3)
 40   phi1(mz,ir1,ir2,ir3)=phi1(mz,ir1,ir2,ir3)+sum
      end
...
c     write(*,*) r1,r2,cthi,v
       ...
       subroutine podvr1(npd,r1a,r1b,r2e,r3e,wvib,evib,
     &                  trad1,xrad1,amu1)
       include 'parmar.f'
      implicit real*8(a-h,o-z)
      parameter (npod=300)
...
c         call radtobond(r1,r2e,cthe,rr1,rr2,cth)
 ...
 17      continue
      ...
      subroutine podvr2(npd,r2a,r2b,r1e,r3e,wvib2,evib2,
     &trad2,xrad2,amu2)
      include 'parmar.f'
      implicit real*8(a-h,o-z)
      parameter (npod=300)
