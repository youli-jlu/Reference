...
c     kl : the total number of Lanczos steps
      ...
      rr2=1.8102073945d0
      theta=104.5d0
      cthae=dcos(theta*pi/180.0d0)
      write(*,*) 'R(H-O)= ',rr1
      write(*,*) 'R(O-H)= ',rr2
      write(*,*) 'A(H-O-H)= ',theta
      call bondtorad(rr1,rr2,cthae,r1e,r2e,cthe)
      write(*,*)'r1e,r2e,cthe= ',r1e,r2e,dacos(cthe)*180.0/pi
...
c     calculate potential matrix   
      ...
      do 3 j=1,nr2
      r2=xrad2(j)
      call radtobond(r1,r2,cthe,rr1,rr2,cth)
        vpot=v(rr1,rr2,cth)
...
C       EIGENFUNCTION      Z(J,I),J=1,N
 ...
 100  H=H-F*G
  ...
  190 CONTINUE
      ...
      v=vpot
c      write(33,*) rr1,rr2,thth*180./pi,vpot
      end


       subroutine podvr1(npd,r1a,r1b,r2e,cthe,wvib1,evib1,
     &                  trad1,xrad1,amu1)
       include 'parmar.f'
      implicit real*8(a-h,o-z)
      parameter (npod=300)
