...
c      th=(180.0-75.5003530d0)
c      theta=th*dacos(-1.0d0)/180.0d0
c      r1=0.9579205d0
c      rr1=r1/0.5291772108d0
c      do r2=0.5,5.0d0,0.0001
c       rr2=r2/0.5291772108d0
c       call POTS(v,rr1,rr2,theta)
c      write(6,999) th,r1,r2,v
c       enddo 
c999    format(1x,f8.2,2f15.7,f20.8)
c       end 
