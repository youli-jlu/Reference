       ...
       th=(180.0-75.5003530d0)
       theta=th*dacos(-1.0d0)/180.0d0
       r1=0.9579205d0
       rr1=r1/0.5291772108d0
       do r2=0.5,5.0d0,0.0001
        rr2=r2/0.5291772108d0
        call POTS(v,rr1,rr2,theta)
       write(6,999) th,r1,r2,v
        enddo 
999    format(1x,f8.2,2f15.7,f20.8)
       end 
